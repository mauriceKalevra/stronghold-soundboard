...
data class Strings(
    ...
    val randomSound: String,
    val randomSoundSubtitle: String,
    val randomSoundToast: String,
...
private val GERMAN = Strings(
    ...
    randomSound = "Zufallsound",
    randomSoundSubtitle = "Ein Sound aus dem kompletten Archiv",
    randomSoundToast = "Zufallsound: %s – %s",
...
private val ENGLISH = Strings(
    ...
    randomSoundSubtitle = "A sound from the whole archive",
    randomSoundToast = "Random sound: %s – %s",
    soundsCount = "%d sounds",
